...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-testfilterindexdelay=<n>", "Throwaway benchmarking hook (not part of any real PR): sleep <n> ms in the block filter index's live per-block indexing path, to widen the compact-filter racing window for testing. (default: 0)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
